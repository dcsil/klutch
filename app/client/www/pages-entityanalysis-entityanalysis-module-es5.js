...
var EntityanalysisPageModule = /** @class */ (function () {
    function EntityanalysisPageModule() {
    }
    ...
    return EntityanalysisPageModule;
}());
...
var EntityanalysisPage = /** @class */ (function () {
    function EntityanalysisPage(router, storage, firebaseService) {
        this.router = router;
        this.storage = storage;
        this.firebaseService = firebaseService;
    }
    EntityanalysisPage.prototype.ngOnInit = function () {
        var _this = this;
        this.storage.get('currentID')
            .then(function (id) {
            console.log("id: ", id);
            _this.docID = id;
            _this.firebaseService.retrieveData("ENTITY", _this.docID).then(function (res) {
                _this.entityData = res;
                console.log("entity analysis:", _this.entityData);
            });
        });
    };
    EntityanalysisPage.prototype.goToSuccess = function () {
        var _this = this;
        // update docID
    ...
    EntityanalysisPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-entityanalysis-entityanalysis-module-es5.js.map