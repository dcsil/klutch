...
var FirebaseService = /** @class */ (function () {
    ...
    FirebaseService.prototype.uploadImageToDB = function (url, id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var docID, docRef, patientID, imageUrl, imageText;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        imageUrl = url;
                        imageText = "";
                        return [4 /*yield*/, docRef.set({ patientID: patientID, imageUrl: imageUrl, imageText: imageText })
                                .then(function (res) {
     ...
     */
    FirebaseService.prototype.uploadImageText = function (imageText, id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    FirebaseService.prototype.recognizeImage = function (imageUrl, docID) {
        ...
        this.http.post(serverUrl, data, { headers: header, responseType: 'text' })
            ...
            _this.uploadImageText(_this.imageText, docID)
                .then(function (res) {
